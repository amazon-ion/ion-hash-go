...
//	ionHashReader, err := NewHashReader(ion.NewReaderStr(""), newIdentityHasherProvider(*tihp))
//	if err != nil {
...
//	tihp := newTestIonHasherProvider("identity")
//	ionHashReader, err := NewHashReader(ion.NewReaderStr("1 2 3"), newIdentityHasherProvider(*tihp))
//	if err != nil {
//		t.Fatalf("expected NewHashReader() to successfully create a HashReader; %s", err.Error())
//	}
//
...
//
//	tihp := newTestIonHasherProvider("identity")
//	ionHashReader, err := NewHashReader(ionReader, newIdentityHasherProvider(*tihp))
//	if err != nil {
//		t.Fatalf("expected NewHashReader() to successfully create a HashReader; %s", err.Error())
//	}
//
...
//	tihp := newTestIonHasherProvider("identity")
//	ionHashReader, err := NewHashReader(ion.NewReaderStr("[1,2,{a:3,b:4},5]"), newIdentityHasherProvider(*tihp))
//	if err != nil {
//		return err
//	}
//
